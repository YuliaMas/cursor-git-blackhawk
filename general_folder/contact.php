...
$subject ="Новая заявка с сайта github.com";
...
$header .= "From: Новая заявка <julia.masechko.web@gmail.com>\n\n";
$mail = mail("julia.masechko.web@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
